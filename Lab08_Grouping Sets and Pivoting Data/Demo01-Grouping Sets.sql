...
GROUP BY GROUPING SETS((cat.ParentProductCategoryName, cat.ProductCategoryName), ()) --All Combi + Total
--GROUP BY GROUPING SETS(cat.ParentProductCategoryName,(cat.ParentProductCategoryName, cat.ProductCategoryName), ()) -- All Combi + SubTotal + Total = ROLLUP
